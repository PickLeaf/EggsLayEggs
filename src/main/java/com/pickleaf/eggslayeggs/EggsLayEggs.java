...
@Mod(
        modid = EggsLayEggs.MODID,
        version = EggsLayEggs.VERSION,
...
public class EggsLayEggs {
    ...
    @SidedProxy(clientSide = "com.pickleaf.eggslayeggs.ClientProxy",
            serverSide = "com.pickleaf.eggslayeggs.CommonProxy")
